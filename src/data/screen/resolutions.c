...
/*                                                   +#+                      */
/*   Created: 2024/11/08 19:22:57 by fras          #+#    #+#                 */
/*   Updated: 2024/11/08 19:28:05 by fras          ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	decrease_resolution(t_gfx_data *graphics)
{
	...
	if (old_resolution == 0)
	{
		printf("Screen resolution already at lowest (%d x %d)\n", \
...
void	increase_resolution(t_gfx_data *graphics)
{
	...
	{
		printf("Screen resolution already at heighest (%d x %d)\n", \
				screen_width(), screen_height());
		return ;
	}
